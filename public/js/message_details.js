...
var app = new Vue({
    ...
    data: {
        is_loading: false,
        js_enabled: true,
        sa_options: [{ value: 'ham', text: 'The message is clean' }, { value: 'spam', text: 'The message is spam' }, { value: 'report', text: 'Report and mark as spam' }, { value: 'revoke', text: 'Report as clean and release' }],
        sa_action: null
    },
    methods: {
